...
enum ApiSearchAttributes { API_TITLE, API_YEAR, API_OMDBID, API_IMDBID, XMLS_TYPE, API_POSTER, API_IMAGE, API_DESCRIPTION, API_NBATTRIBUTES };
...
typedef struct {
    std::string values[API_NBATTRIBUTES];
    bool isFromJson;
} apiSearchValues;
