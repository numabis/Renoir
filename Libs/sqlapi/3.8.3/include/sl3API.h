...
typedef int (*sqlite3_open_t)(const SAChar *filename, sqlite3 **ppDb);
...
typedef const SAChar *(*sqlite3_errmsg_t)(sqlite3*);
...
typedef int (*sqlite3_bind_text_t)(sqlite3_stmt*, int, const SAChar*, int n, void(*)(void*));
...
typedef const SAChar *(*sqlite3_column_name_t)(sqlite3_stmt*, int N);
...
typedef const SAChar *(*sqlite3_column_decltype_t)(sqlite3_stmt *, int);
...
typedef const SAChar *(*sqlite3_column_text_t)(sqlite3_stmt*, int iCol);
...
typedef int (*sqlite3_prepare_t)(
  ...
  const SAChar *zSql,       /* SQL statement, UTF-16 encoded */
  int nByte,              /* Maximum length of zSql in bytes. */
  sqlite3_stmt **ppStmt,  /* OUT: Statement handle */
  const SAChar **pzTail     /* OUT: Pointer to unused portion of zSql */
);
